...
<html lang="en">
  <head>
    ...
    <title>NEW CATEGORY | PlayQuest</title>
    ...
    <form action="new_category.php" method="post">
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">New Category</p>
                      ...
                      <fieldset>
                        <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Category Name</p>
                        <input
                      ...
                      <fieldset>
                        ...
                        <input type="submit" onclick="submit()" id="submit" value="Add Category" style=" font-size: 15px; padding: 10px 25px;background-color: #ff9d5c; color: white;border-radius: 8px;border: #ff9d5c;"/>
