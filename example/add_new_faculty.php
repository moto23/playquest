...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_query = "INSERT INTO faculty (faculty_name, username, email,password,department) VALUES (?, ?, ?, ?, ?)";
    $insert_stmt = $conn->prepare($insert_query);

    if ($insert_stmt) {
        $insert_stmt->bind_param("sssss", $faculty_name, $username, $email, $password, $department);
        $insert_stmt->execute();
        $insert_stmt->close();
...
<html lang="en">
  <head>
    ...
    <title>CREATE FACULTY PROFILE | PlayQuest</title>
              ...
              <div class="card demo-icons">
                ...
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Register New Faculty</p>
                      ...
                      <fieldset>
                        <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Faculty Name</p>
                        <input
                      ...
                      <!-- ended 4th one -->
                      <!-- 5th one -->
                      <p style="color: #ff9d5c;font-size: 22px;font-weight: bold; ">Faculty Department</p>
                      <div 
                      ...
                      <!-- last one -->
                      <fieldset>
                        <input type="submit" onclick="submit()" id="submit" value="Add Faculty" style=" font-size: 15px; padding: 10px 25px;background-color: #ff9d5c; color: white;border-radius: 8px;border: #ff9d5c;"/>
                      </fieldset>
                      <!-- ended last one -->
                    </div>
