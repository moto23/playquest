...
<html lang="en">
  <head>
    ...
    <script>
      ...
      function edit(champ = "") {
        window.open(`create_new_championship.php?category=${champ}`)
      }

      function addnewchampionship() {
        window.open("create_new_championship.php")
      }
    </script>
                ...
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      ...
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">All Championships</p>
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr><td>".$row["champ_name"]."</td></tr>";
                            }
                            echo "</table>";
                        }
                        else{
                    ...
                    ?>
                      ...
                      <div style="display: flex; flex-direction: row;">
                            ...
                            <div style=" display: inline-flex; min-width: 112ch; font-size: 16px;" class="select"> 
                                        <button onclick="addnewchampionship()" style="float: right;color: #ffffff; margin: 2px; font-size: 15px; height: 30px;background-color: #ff9d5c;border: 1px solid #ff9d5c;"  id="dodropdown">Add New Championship</button>
