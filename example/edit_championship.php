...
<html lang="en">
  <head>
    ...
    <title>EDIT NEW CHAMPIONSHIP | PlayQuest</title>
              ...
              <div class="card demo-icons">
                ...
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Edit Championship</p>
                      ...
                      <div 
                        ...
                        class="select"
                      >
                        <select id="select_dropdown" style="border-color: #ff9d5c;" >
                      ...
                      <fieldset>
                        ...
                        <input type="submit" onclick="submit()" id="submit" value="Edit Championship" style=" font-size: 15px; padding: 10px 25px;background-color: #ff9d5c; color: white;border-radius: 8px;border: #ff9d5c;"/>
