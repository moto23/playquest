...
<html lang="en">
  <head>
    ...
    <title> Question Bank | PlayQuest</title>
                ...
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      ...
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Question Bank</p>
                            ...
                            <div style="display: flex; flex-direction: row;">
                              <div style=" display: flex; min-width: 508ch; font-size: 16px;"  class="select">
                                <div  class="card-title">
                                  <p> Total Participants: <span style="color: #ff9d5c;">212</span></p>
                                  <p>Qualification Required:Any</p>
                                  <p>Category:Computer Science</p>
                                  <p>Start Date:07 May 2020 | 10:22 AM IST</p>
                                </div>
                              </div>
                            </div>
