...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['labelname'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO label (label_name) VALUES (?)");
        ...
        echo "Label name is not set in the POST data.";
    }
} 
?>
...
<html lang="en">
  <head>
    ...
    <title>NEW LABEL | PlayQuest</title>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card demo-icons">
                ...
                <!-- form start  -->
                <form action="new_label.php" method="POST">
                <div class="card-header">
                  <div class="container">
                    <!-- 1st one -->
                    <div id="contact">
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">New Label</p>
                      ...
                      <fieldset>
                        <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Label Name</p>
                        <input
                      ...
                      <fieldset>
                        ...
                        <input type="submit" onclick="submit()" id="submit" value="Add Label" style=" font-size: 15px; padding: 10px 25px;background-color: #ff9d5c; color: white;border-radius: 8px;border: #ff9d5c;"/>
